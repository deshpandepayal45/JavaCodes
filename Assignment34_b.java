...
//user and return first occurance of of that no

import java.util.*;
class Assignment34_b
{
    public static int getFirstOccurance(int args[],int n,int no)
    {
        int iCnt=0,iTemp=-1;
    ...
    public static void main(String[] args)
    {
        ...
        int iRet=0;
        iRet=getFirstOccurance(Arr,size,No);
